...
class SwallowedExceptionSuite extends FunSuite {
  test("issue-51")(throw new Exception("i am not reported") with NoStackTrace)

  test("issue-650")(throw new IllegalAccessError("i am reported"))

  test("should not be executed")(assertEquals(1, 1))
}
