...
class DoubleAssertionsFrameworkSuite extends BaseSuite {
  test("Assert Equals NaN Fails".fail)(assertEqualsDouble(1.234, Double.NaN, 0.0))

  test("Assert NaN Equals Fails".fail)(assertEqualsDouble(Double.NaN, 1.234, 0.0))

  test("Assert NaN Equals NaN")(assertEqualsDouble(Double.NaN, Double.NaN, 0.0))
  ...
  test("All Infinities")(assertEqualsDouble(
