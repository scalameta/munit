...
class Issue1002AfterAllFrameworkSuite extends FunSuite {
  ...
  private val futureFixture = new FutureFixture[Unit](name = "futureFixture") {
    ...
    override def afterAll(): Future[Unit] = Future(Thread.sleep(50))
  }
...
object Issue1002AfterAllFrameworkSuite
    extends FrameworkTest(
      ...
      """|==> success munit.Issue1002AfterAllFrameworkSuite.dummy
         |==> failure munit.Issue1002AfterAllFrameworkSuite.afterAll(munit.Issue1002AfterAllFrameworkSuite) - tests/jvm/src/main/scala/munit/Issue1002AfterAllFrameworkSuite.scala:19 assertion failed
         |18:
         |19:  override def afterAll(): Unit = assert(false)
         |20:
         |""".stripMargin,
    )
